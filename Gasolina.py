...
st.image("tabla.png", caption="Tabla de equivalencia de estados.", width=100)
...
gasolina =  pd.read_csv('PrecioGasolinaRegular.csv')
...
st.write('Dadas las variables que se seleccionaron, el costo predicho es:', prediccion)
